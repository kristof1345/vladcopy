...
const FAQ = () => {
  return (
    <div className="s:pb-32 pb-24 flex flex-col items-center relative">
      <h1 className="text-center font-medium text-zinc-50 text-5xl pb-16">
        FAQ
      </h1>
      <div className="max-w-3xl">
        <h2 className="text-zinc-50 text-3xl s:pb-2 pb-3 font-semibold">
          What services do you offer?
        </h2>
        <p className="text-zinc-300 s:text-2xl text-xl pb-12">
